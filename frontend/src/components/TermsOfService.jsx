              ...
              <CardContent className="text-gray-300 space-y-6 p-8">
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    ...
                    <p><strong>3.2.</strong> Все платежи являются окончательными и не подлежат возврату независимо от причин, включая, но не ограничиваясь, неиспользованием Услуг, нарушением Условий Пользователем или техническими проблемами.</p>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-white mb-4">4. Политика невозврата</h2>
                  <div className="space-y-4">
                    <p><strong>4.1.</strong> Пользователь соглашается, что все платежи за Услуги являются невозвратными. Возврат средств не производится ни при каких обстоятельствах, включая:</p>
                    <ul className="list-disc pl-6 space-y-2">
                      <li>Отказ Пользователя от использования Услуг;</li>
                      <li>Технические сбои, не зависящие от Провайдера;</li>
                      <li>Нарушение Пользователем настоящих Условий;</li>
                      <li>Досрочное прекращение предоставления Услуг по инициативе Пользователя.</li>
                    </ul>
                    <p><strong>4.2.</strong> Пользователь обязан самостоятельно убедиться в соответствии Услуг своим потребностям до совершения оплаты.</p>
                  </div>
                </section>
